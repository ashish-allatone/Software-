...
export default function HomeNavBar() {
  ...
  return (
    <div className="h-32 p-5 header-bg bg-slate-50  border-gb border-slate-300">
      <div className="flex space-x-3">
        <div className="flex w-12 h-12 bg-white rounded-lg items-center justify-center">
            <Building2/>
        </div>
        <div className="flex flex-col">
            <p className="text-slate-900 font-semibold text-lg">Hello, AllATone Web Developer</p>
            <span className="text-sm">Manas</span>
        </div>
      </div>
